...
/**
 * Project05 -- SellerStatisticsProductReportPanel
 *
 ...
 */
public class SellerStatisticsProductReportPanel extends JPanel {
    JLabel customerReportMessage;
    JButton back;
    JTable customerTable;
    JButton sort;
    ArrayList<SellerSortProduct> tableDataArr;
     ...
     * and a flow layout.
     */
    public SellerStatisticsProductReportPanel() {
    }

    public SellerStatisticsProductReportPanel(JFrame frame, JPanel sellerStatistics, ActionListener actionListener) {
        ...
        customerReportMessage.setText("Product Report");
    ...
    public void setTableData(ArrayList<SellerSortProduct> resultList) {
        tableDataArr = resultList;
        DefaultTableModel model = new DefaultTableModel() {
            final String[] columnHeaders = {"Product Name", "Number of sales"};
        ...
        int i = 0;
        for (SellerSortProduct item : resultList) {
            customerTable.setValueAt(item.getFlavorName(), i, 0);
